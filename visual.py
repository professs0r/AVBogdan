...
x_lines1 = [4, 54, 54, 4, 4]
y_lines1 = [4, 4, 54, 54, 4]
x_lines2 = [29, 29]
y_lines2 = [4, 54]
x_lines3 = [4, 54]
y_lines3 = [29, 29]
...
data_lines1_on_plan = go.Scatter( x = x_lines1,
                                  y = y_lines1,
                                  fillcolor = 'black',
                                  mode = 'lines'
                                )
data_lines2_on_plan = go.Scatter( x = x_lines2,
                                  y = y_lines2,
                                  mode = 'lines'
                                )
data_lines3_on_plan = go.Scatter( x = x_lines3,
                                  y = y_lines3,
                                  mode = 'lines'
                                )
...
fig.add_trace(data_lines1_on_plan)                        # подгружаем одно в другое для корректной работы (линии)
fig.add_trace(data_lines2_on_plan)
fig.add_trace(data_lines3_on_plan)
...
# добавил ещё один комментарий через редактор VIM
# добавил третий комметнтарий через редактор VIM
# добавил четвёртный комментарий через редактор VIM
# добавил комментарий через PyCharm
# ещё один комментарий через редактор VIM
